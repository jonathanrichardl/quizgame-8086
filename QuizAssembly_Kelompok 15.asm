...
TEXT9 db 13,10,'Pilih Topic (1. Marvel, 2.Indonesia, 3.Biologi, 4.Pengetahuan Umum, 5.Kartun)',13,10,'$'
TEXT10 db 13,10,'Dengan Score player1 ', '$' 
TEXT11 db ' dan score player2 ', '$'
...
NAMAPLAYER macro player
    mov ah, 9 ;SERVICE TO DISPLAY STRING.
            mov dx, offset player + 2 ;MUST END WITH '$'.
            int 21h
            mov ah, 4ch
            int 21h
